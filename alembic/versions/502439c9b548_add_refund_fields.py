...
def upgrade() -> None:
    ...
    with op.batch_alter_table('users', schema=None) as batch_op:
        batch_op.add_column(sa.Column('trust_score', sa.Float(), nullable=False))
        batch_op.add_column(sa.Column('trust_tier', sa.Enum('S', 'A', 'B', 'C', name='trusttier'), nullable=False))
        batch_op.add_column(sa.Column('github_id', sa.String(), nullable=True))
        batch_op.add_column(sa.Column('github_bonus_claimed', sa.Boolean(), nullable=False))
        batch_op.add_column(sa.Column('consolation_total', sa.Float(), nullable=False))
        batch_op.add_column(sa.Column('is_arbiter', sa.Boolean(), nullable=False))
        batch_op.add_column(sa.Column('staked_amount', sa.Float(), nullable=False))
        batch_op.add_column(sa.Column('stake_bonus', sa.Float(), nullable=False))
